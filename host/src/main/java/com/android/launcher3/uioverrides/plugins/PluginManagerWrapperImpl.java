...
/**
 * {@link PluginManagerWrapper} 的具体实现，在宿主 App 内组装 SystemUI 插件框架
 * （PluginManagerImpl + PluginActionManager + PluginInstance）。
 *
 * <p>用手工构造替代原 Launcher3 / Dagger 的注入方式，使整套插件机制能在独立 Gradle 应用中运行。
 */
public class PluginManagerWrapperImpl extends PluginManagerWrapper {
    ...
    public <T extends Plugin> void addPluginListener(
        ...
        mPluginManager.addPluginListener(action, listener, pluginClass, allowMultiple);
    }
